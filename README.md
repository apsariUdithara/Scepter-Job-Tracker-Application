...
```jsx
const App = () => {
  return <h1>Scepter Job Tracker App</h1> App</h1>;
};
export default App;
```
...
const Landing = () => {
  return (
    <StyledWrapper>
      <nav>
        <img src={logo} alt='scepter' className='logo' />
      </nav>
...
const Logo = () => {
  return <img src={logo} alt='scepter' className='logo' />;
};
